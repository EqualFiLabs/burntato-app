...
export const alt = "Burntato — fully onchain Hot Potato on Robinhood Chain Testnet";
...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "center", padding: 80, background: "radial-gradient(circle at 75% 25%, #5f2413 0, #160a06 42%, #050403 75%)", color: "#fff5e9" }}>
      ...
      <div style={{ display: "flex", marginTop: 48, color: "#ffbd82", fontSize: 25 }}>Live on Robinhood Chain Testnet · Testnet assets only</div>
    </div>,
    size,
  );
}
